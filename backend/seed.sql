...
INSERT INTO dishes (category_id, name, description, price, `portion`, image_url, gallery, rating, prep_time_minutes, restaurant, available) VALUES
  (2, 'Doro Wat',
   ...
   4.8, 20, 'Daron Hotel Kitchen', TRUE),
  ...
  (4, 'Tibs (Beef)',
   ...
   4.7, 15, 'Daron Hotel Kitchen', TRUE),
  ...
  (3, 'Shiro Firfir',
   ...
   4.6, 12, 'Daron Hotel Kitchen', TRUE),
  ...
  (2, 'Kitfo',
   ...
   4.9, 10, 'Daron Hotel Kitchen', TRUE),

  (2, 'Injera Platter',
   'A generous sharing platter of sourdough injera topped with doro wat, misir, gomen, tikil gomen and ayib. The full Daron Hotel dining experience on one plate.',
   560, 'Serves 2 • Mixed',
   ...
   4.8, 25, 'Daron Hotel Kitchen', TRUE),
  ...
  (5, 'Bunna (Coffee)',
   ...
   4.9, 8, 'Daron Hotel Kitchen', TRUE),
  ...
  (3, 'Misir Wat',
   ...
   4.5, 18, 'Daron Hotel Kitchen', TRUE),

  (6, 'Honey Cake',
   'Moist sponge cake made with tej (Ethiopian honey wine) and spiced with cinnamon and tej honey glaze. A sweet finish to your meal at Daron Hotel.',
   120, '1 slice • 150g',
   ...
   4.7, 5, 'Daron Hotel Kitchen', TRUE);